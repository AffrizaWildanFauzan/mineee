...
for cols,nm in [(META_v24,"META v24"),(META,"META v26")]:
...
META_SETS={"v29_a_metaV24":META_v24,"v29_b_metaV26":META}
...
print("\nREKOMENDASI: kirim submission_v29_b_metaV26.csv sebagai kandidat utama.")
print("Di holdout TERSEGEL META v26 unggul +0.0017 dari META v24, dan di OOF 4000")
print("user unggul +0.0006. Satu-satunya pengukuran yang memihak v24 adalah public")
print("LB (~310 user) -- yang paling berisik dari ketiganya.")

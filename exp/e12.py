...
for split in range(NSPLIT):
    t0=time.time()
    rng=np.random.RandomState(400+split); perm=rng.permutation(len(allu))
    ...
    blend(["B_v24_ridge","B_v24_rank"],"BL2_B")
    blend(["B_v24_ridge","C_text_clf_ridge","B_v24_rank","C_text_clf_rank"],"BL4_BC")
    blend(["A_v21_ridge","B_v24_ridge","C_text_clf_ridge","A_v21_rank","B_v24_rank","C_text_clf_rank"],"BL6_ABC")
    pd.DataFrame(rows).to_csv("/home/user/mineee/exp/e12_results.csv",index=False)
